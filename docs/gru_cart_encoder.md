...
* **Data:** `data/sessions.parquet`, **temporal split** (earliest
  ...
  — 222,296 training sequences.
* **Optimizer:** Adam(lr=1e-3), 3 epochs, batch 2048, ~40s on CPU.

## Held-out next-item metrics (full 15K-catalogue ranking)
| Metric | Trained encoder | Random-init baseline |
|---|---:|---:|
| Recall@1 | 0.0470 | 0.0000 |
| Recall@10 | 0.5232 | 0.0003 |
| Recall@20 | 0.9528 | 0.0004 |
| MRR | 0.1749 | 0.0005 |
...
alone. Evaluated on 22,072 held-out cart steps.
